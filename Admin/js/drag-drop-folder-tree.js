...
************************************************************************************************************/	
	...
	function JSDragDropTree()
	{
		...
		this.floatingContainer.style.position = 'relative';
		this.floatingContainer.style.display='block';
		this.floatingContainer.id = 'floatingContainer';
		this.insertAsSub = true;
		document.body.appendChild(this.floatingContainer);
		this.dragDropTimer = -1;
		this.dragNode_noSiblings = false;
		this.currentItemToEdit = true;
	    ...
	    dragDropCountLevels: function (obj, direction, stopAtObject) {
	        ...
	        if (direction == 'up') {
	            while (obj.parentNode && obj.parentNode != stopAtObject) {
	                obj = obj.parentNode;
	                if (obj.tagName == 'UL') countLevels = countLevels / 1 + 5;
	                //AR Change - if(obj.tagName=='UL')countLevels = countLevels/1 +1;
	            }
	            return countLevels;
	        }
